...
class GettextMessageSource extends CGettextMessageSource
{
    ...
    {
        if (!isset($this->translationFiles[$category][$language])) {
        ...
        if ($this->useMoFile) {
            $this->translationFiles[$category][$language] .= self::MO_FILE_EXT;
        } else {
            $this->translationFiles[$category][$language] .= self::PO_FILE_EXT;
        }

        return $this->translationFiles[$category][$language];
    }
